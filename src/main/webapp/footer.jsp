...
<script type="text/javascript" src="${ctx}/lib/layer/extend/layer.ext.js"></script>
<script type="text/javascript" src="${ctx}/lib/laypage/1.2/laypage.js"></script> 
<script type="text/javascript" src="${ctx}/script/H-ui.js"></script> 
<script type="text/javascript" src="${ctx}/script/H-ui.admin.js"></script> 
