...
<div class="pd-20">
    <div class="text-c mb-10">
        ...
        <a href="javascript:;" onclick="store_add('添加店铺','import/storeEdit','800','620')" class="btn btn-success radius">
...
<script type="text/x-handlebars-template" id="user-template">
    ...
    <tr class="text-c">
        ...
        <td class="td-manage">
            ...
            <input class="btn btn-success size-S radius" type="button" onclick="store_edit('店铺编辑','<%=request.getContextPath()%>/import/storeEdit?id={{id}}','830','520')" value="修改"/>
        </td>
    </tr>
    {{/each}}
</script>
